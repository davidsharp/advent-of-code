...
const decode = panel => {
  ...
  // get the top bar
  decodings['a'] = characters[7].split('').find(x=>characters[1].indexOf(x)==-1)
  ...
  // 2 will also be missing half of 1
  ...
  // 3 is not 2 or 5
  characters[0] = _235.find(d=>d!=characters[2]&&d!=characters[5])

  console.log(digits,display,characters,decodings)
}
